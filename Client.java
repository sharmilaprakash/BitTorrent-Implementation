...
public class Client {
	...
	static void update_summary_file() throws FileNotFoundException, UnsupportedEncodingException {
		...
		File summary = new File("D:\\Workspace\\Java Noob\\Networking-Final-Project-master\\Networking-Final-Project-master\\BitTorrent Implementation\\client" + client_num,
				"summary.txt");
	...
	static void get_file(ObjectInputStream file_in) throws FileNotFoundException, IOException, ClassNotFoundException {
		...
		File newFile = new File("D:\\Workspace\\Java Noob\\Networking-Final-Project-master\\Networking-Final-Project-master\\BitTorrent Implementation\\client" + client_num, chunk_name);
	...
	void DownloadFromFileOwner() throws ClassNotFoundException, FileNotFoundException {
		...
		File configuration = new File("D:\\Workspace\\Java Noob\\Networking-Final-Project-master\\Networking-Final-Project-master\\BitTorrent Implementation\\config.txt");
		try {
		...
		// }
			...
			if (in == null){
				System.err.println("Connection Terminated! Change configuration file to add more clients.");
				System.exit(1);
			} else {
...
//						File file_config = new File("D:\\Workspace\\Java Noob\\Networking-Final-Project-master\\Networking-Final-Project-master\\BitTorrent Implementation\\client" + client_num + "\\file-info.txt");
//						Scanner fileinfo = new Scanner(file_config);
//						String merged_file_name = fileinfo.next();
//						String merged_file_ext = fileinfo.next();
//						fileinfo.close();
						FileSplit.mergeFiles(own_files, "D:\\Workspace\\Java Noob\\Networking-Final-Project-master\\Networking-Final-Project-master\\BitTorrent Implementation\\client" + client_num + "\\" + "merged_file");
